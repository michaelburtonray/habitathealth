...
export default function TextWithPercentages(props) {
  ...
  return (
    <div className="text-with-percentages bg-green lg:grid lg:grid-cols-2 my-[--padding] px-5 lg:px-10 py-10 lg:py-20 rounded-2xl">
      ...
      <div className="text-with-percentages__percentages max-lg:mt-10">
        {percentages.map(({ _key, annotation, text, value }, i) => (
          <div key={_key} className="border-b border-cream/50 flex max-lg:flex-col gap-6 first:pt-0 py-10 lg:py-14">
